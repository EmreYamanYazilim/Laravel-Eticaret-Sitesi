                ...
                <div class="row align-items-start align-items-md-center justify-content-end">
                    ...
                    <h1 class="mb-2">{{ $slider->name ?? __('Slider İsmi') }}</h1> {{--    eğer slider->name gelmezse slider ismi gelecek --}}
                        <div class="intro-text text-center text-md-left">
                            ...
                            <p>
                                <a href="{{ $slider->link ?? ''}}" class="btn btn-sm btn-primary">Ürünlerimiz</a>{{-- Urlden vererek  yanına / atarak daha dinamik yaptık domaini değişsek bile sıkıntı yaşamıcaz  --}}
                            </p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="item">
                                        <div class="block-4 text-center">
                                            ...
                                            <div class="block-4-text p-4">
                                                ...
                                                <p class="mb-0">{{ $item->categoryHasOne->name }}</p>
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-7 mb-5">
                        <a href="{{ route('discount')  }}"><img src="{{ $settings['kampanya'] ?? '' }}" alt="Image placeholder" class="img-fluid rounded"></a>
                    </div>
                    <div class="col-md-12 col-lg-5 text-center pl-md-5">
                        <h4 style="color: orangered;" >{{ $settings['kampanya_title'] }}</h4>
